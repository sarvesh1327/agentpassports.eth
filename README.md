...
| Demo owner ENS | `TODO` |
| Demo agent ENS | `TODO` |
| `AgentPolicyExecutor` | `NEXT_PUBLIC_EXECUTOR_ADDRESS` |
| `TaskLog` | `NEXT_PUBLIC_TASK_LOG_ADDRESS` |
...
3. Submit registration. The app creates or configures the ENS subname, writes resolver records, sets policy, and deposits gas budget.
...
- Pinata/IPFS metadata generation is planned for the next version. For now metadata URI fields are optional or manually supplied.
